package io.github.youndie.petich.idempotency
...
public data class IdempotencyRecord(
    val key: String,
...
public interface IdempotencyRepository {
    ...
    public suspend fun tryClaim(
        key: String,
        requestFingerprint: String,
    ): Boolean

    public suspend fun find(key: String): IdempotencyRecord?
}
