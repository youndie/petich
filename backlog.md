...
**Every item is closed, and `io.github.youndie.petich` 0.2.0 is on Maven Central with native
variants.** Fifteen done, one dropped: [B-16](docs/backlog/B-16-access-scoring-decimal-fixture.md)
asked what to do with a suite whose fixture does decimal finance, and the answer was *leave it on
the JVM* — the native target loses that fixture's arithmetic, not any part of petich.
