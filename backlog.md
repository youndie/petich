...
|---|---|---|---|---|
| [B-65](docs/backlog/B-65-the-engine-never-writes-processing.md) `[~]` | The engine never writes PROCESSING, so a saga that dies mid-pass is found by neither queue | P1 | M | - |
