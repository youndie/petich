...
| [B-34](docs/backlog/B-34-the-two-stores-type-a-column-differently.md) `[ ]` | The two stores type the same column differently, and the audit cannot see it | P1 | S | - |
| [B-35](docs/backlog/B-35-an-emit-before-a-non-proceed-outcome-vanishes.md) `[ ]` | A member that emits and then suspends loses the announcement, silently | P1 | M | - |
