...
* **[B-27](docs/backlog/B-27-release-0-3-0-before-the-redesign.md) blocks everything**, on purpose.
  0.3.0 is merged, rehearsed and snapshotted; Central still serves 0.2.0, in which a failed step is
  never compensated. Making "release first" an edge in the graph rather than a sentence is the whole
...
|---|---|---|---|---|
| [B-27](docs/backlog/B-27-release-0-3-0-before-the-redesign.md) `[ ]` | 0.3.0 goes to Central before the redesign starts | P0 | XS | - |
| [B-28](docs/backlog/B-28-the-types-and-the-builder.md) `[ ]` | PetichStep, PetichCheck and a definition that says the order out loud | P1 | L | B-27 |
